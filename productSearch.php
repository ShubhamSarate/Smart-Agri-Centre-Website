	...
	<body class="landing">
		...
		<!-- One -->
			...
			<section id="one" class="wrapper style1 align-center"  >
				<div class="container" >
						<header>
							<a href="javascript:history.back()" style="display:inline-block;padding:10px 14px;background:#007bff;color:#fff;border-radius:6px;text-decoration:none;margin-bottom:12px;">&larr; Back</a>
					...
					<form method="post" action="#">
						<div class="row uniform 50%">
							...
							<div class="12u 12u$(small)">
						 	 <h2 style="font-size: 120%;">Search by Category</h2>
						</div>
						<div class="12u 12u$(small)">
						 	 <br>
							</div>
						<div class="4u 12u$(small)">
								...
								<label for="priority-low"><h2 style="font-size: 120%;">Fertilizers</h2></label>
							</div>
							<div class="4u 12u$(small)">
								<input type="radio" id="priority-normal" name="priority">
								<label for="priority-normal"><h2 style="font-size: 120%;">Seeds</h2></label>
							</div>
							<div class="4u$ 12u$(small)">
								<input type="radio" id="priority-high" name="priority">
								<label for="priority-high"><h2 style="font-size: 120%;"> Tools & Equipment</h2></label>
							</div>
